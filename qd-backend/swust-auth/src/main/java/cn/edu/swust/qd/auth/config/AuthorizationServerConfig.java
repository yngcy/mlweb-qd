...
import cn.edu.swust.qd.auth.oauth2.extension.captcha.CaptchaAuthenticationConverter;
import cn.edu.swust.qd.auth.oauth2.extension.captcha.CaptchaAuthenticationProvider;
import cn.edu.swust.qd.auth.oauth2.extension.password.PasswordAuthenticationConverter;
import cn.edu.swust.qd.auth.oauth2.extension.password.PasswordAuthenticationProvider;
import cn.edu.swust.qd.auth.oauth2.extension.smscode.SmsCodeAuthenticationConverter;
import cn.edu.swust.qd.auth.oauth2.extension.smscode.SmsCodeAuthenticationProvider;
import cn.edu.swust.qd.auth.oauth2.extension.smscode.SmsCodeAuthenticationToken;
import cn.edu.swust.qd.auth.oauth2.extension.wechat.WechatAuthenticationConverter;
import cn.edu.swust.qd.auth.oauth2.extension.wechat.WechatAuthenticationProvider;
import cn.edu.swust.qd.auth.oauth2.extension.wechat.WechatAuthenticationToken;
import cn.edu.swust.qd.auth.oauth2.handler.MyAuthenticationFailureHandler;
import cn.edu.swust.qd.auth.oauth2.handler.MyAuthenticationSuccessHandler;
import cn.edu.swust.qd.auth.oauth2.jackson.SysUserMixin;
import cn.edu.swust.qd.auth.oauth2.odic.CustomOidcAuthenticationConverter;
import cn.edu.swust.qd.auth.oauth2.odic.CustomOidcAuthenticationProvider;
import cn.edu.swust.qd.auth.oauth2.odic.CustomOidcUserInfoService;
import cn.edu.swust.qd.auth.service.MemberDetailsService;
