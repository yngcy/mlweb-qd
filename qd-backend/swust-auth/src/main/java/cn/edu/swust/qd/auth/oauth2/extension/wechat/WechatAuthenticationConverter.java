package cn.edu.swust.qd.auth.oauth2.extension.wechat;

import cn.edu.swust.qd.auth.utils.OAuth2EndpointUtils;
 ...
 * 微信小程序认证参数解析器
 * <br>
 * 解析请求参数中的微信小程序Code，并构建相应的身份验证（Authentication）对象
 *
